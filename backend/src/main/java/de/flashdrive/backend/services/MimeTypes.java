...
public class MimeTypes {
    ...
    public static final String MIME_TEXT_PLAIN          = "text/plain; charset=utf-8";
    public static final String MIME_TEXT_RICHTEXT       = "text/richtext";
    public static final String MIME_TEXT_RTF          = "text/rtf";
    public static final String MIME_TEXT_HTML         = "text/html; charset=utf-8";
    ...
    static {
        mimeTypeMapping = new HashMap<String, String>(200) {
            ...
            }
            {
                ...
                put1("java", MIME_APPLICATION_OCTET_STREAM);
